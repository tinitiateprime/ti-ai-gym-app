// App.jsx (or App.js) — FULL CLEAN VERSION (no duplicate screens)
...
// ✅ Exercise Logger (SQLite + Reports)
import ExerciseLoggerHomeScreen from "./screens/member/exercise/ExerciseLoggerHomeScreen";
import ExerciseSessionScreen from "./screens/member/exercise/ExerciseSessionScreen";
import ExerciseReportsScreen from "./screens/member/exercise/ExerciseReportsScreen";
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <NavigationContainer>
        ...
        >
          ...
          <Stack.Screen
            name="ExerciseLogger"
            component={ExerciseLoggerHomeScreen}
            options={{ title: "My Exercise" }}          // ✅ changed
          />
          <Stack.Screen
            name="ExerciseSession"
            component={ExerciseSessionScreen}
            options={{ title: "Exercise Home" }}        // ✅ changed
          />
          <Stack.Screen name="ExerciseReports" component={ExerciseReportsScreen} options={{ title: "Reports" }} />

          {/* Member Dashboard */}
          <Stack.Screen name="MemberHome" component={MemberHomeScreen} options={{ title: "Member Home" }} />
          <Stack.Screen name="MyProfile" component={MyProfile} options={{ title: "My Profile" }} />
          <Stack.Screen name="MyCalendar" component={MyCalendar} options={{ title: "My Calendar" }} />
          <Stack.Screen name="MySubscription" component={MySubscription} options={{ title: "My Subscriptions" }} />
          <Stack.Screen name="MyPayment" component={MyPayment} options={{ title: "My Payments" }} />
          <Stack.Screen name="MyNotifications" component={MyNotifications} options={{ title: "Notifications" }} />
          <Stack.Screen name="MyWorkoutTracker" component={MyWorkoutTracker} options={{ title: "Workout Tracker" }} />

          {/* Marketplace Home (role-based) */}
          <Stack.Screen name="MarketplaceHome" component={MarketplaceHomeScreen} options={{ title: "Marketplace Home" }} />
          <Stack.Screen name="MarketplaceProfile" component={MarketplaceProfile} options={{ title: "My Profile" }} />
          <Stack.Screen name="MarketplaceServices" component={MarketplaceServices} options={{ title: "My Services" }} />
          <Stack.Screen name="MarketplaceProducts" component={MarketplaceProducts} options={{ title: "My Products" }} />
          <Stack.Screen name="MarketplacePayments" component={MarketplacePayments} options={{ title: "My Payments" }} />
          <Stack.Screen name="MarketplaceNotifications" component={MarketplaceNotifications} options={{ title: "My Notifications" }} />

          {/* Owner Dashboard (role-based) */}
          <Stack.Screen name="OwnerDashboard" component={OwnerDashboardScreen} options={{ title: "Owner Dashboard" }} />
          <Stack.Screen name="OwnerProfile" component={OwnerProfile} options={{ title: "Owner Profile" }} />
          <Stack.Screen name="OwnerCalendar" component={OwnerCalendar} options={{ title: "Owner Calendar" }} />
          <Stack.Screen name="OwnerMember" component={OwnerMember} options={{ title: "Owner Members" }} />
          <Stack.Screen name="OwnerTrainerPage" component={OwnerTrainerPage} options={{ title: "Owner Trainers" }} />
          <Stack.Screen name="OwnerMarket" component={OwnerMarket} options={{ title: "Owner Market" }} />
          <Stack.Screen name="OwnerNotifications" component={OwnerNotifications} options={{ title: "Owner Notifications" }} />
          ...
          <Stack.Screen
            name="OwnerTrainerManagement"
            component={OwnerTrainerManagementScreen}
            options={{ title: "Trainer Management (Owner)" }}
          />
          ...
          <Stack.Screen name="TrainerNotifications" component={TrainerNotificationsScreen} options={{ title: "Trainer Notifications" }} />
        </Stack.Navigator>
      </NavigationContainer>
